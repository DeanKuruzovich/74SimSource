...
test('74388 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x388'], 'chip missing');
});
test('74388 rising CLK captures D', () => {
  const comp = makeComp('74x388');
...
test('74390 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x390'], 'chip missing');
});
test('74390 CLR1=1 → counter 1 = 0', () => {
  const comp = makeComp('74x390');
...
test('74393 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x393'], 'chip missing');
});
test('74393 CLR1=1 → counter 1 = 0', () => {
  const comp = makeComp('74x393');
...
test('74395 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x395'], 'chip missing');
});
test('74395 CLRn=0 → clear all', () => {
  const comp = makeComp('74x395');
...
test('74396 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x396'], 'chip missing');
});
test('74396 rising CLK captures D', () => {
  const comp = makeComp('74x396');
...
test('74398 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x398'], 'chip missing');
});
test('74398 SEL=0: captures A inputs on rising CLK', () => {
  const comp = makeComp('74x398');
...
test('74399 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x399'], 'chip missing');
});
test('74399 uses MUX_QUAD_2TO1_STORED', () => {
  assertEqual(CHIPS_BLOCK_24['74x399'].gates[0].type, 'MUX_QUAD_2TO1_STORED', 'gate type');
});
test('74399 chip has correct pinout count', () => {
  const pins = CHIPS_BLOCK_24['74x399'].pinout.filter(p => p.type !== 'power');
...
test('74401 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x401'], 'chip missing');
});
test('74401 stub → outputs LOW', () => {
  const comp = makeComp('74x401');
  setPins(comp, { CP:0, D:0, S0:0, S1:0, S2:0, CWE:1, P:1, MR:0 });
  evalGate(comp);
  assertEqual(getPin(comp,'Q'),  0, 'Q=0');
  assertEqual(getPin(comp,'ER'), 0, 'ER=0');
});
test('74401 outputs are driven (not HiZ)', () => {
  const comp = makeComp('74x401');
  setPins(comp, { CP:0, D:0, S0:0, S1:0, S2:0, CWE:1, P:1, MR:0 });
  evalGate(comp);
  assert(getPin(comp,'Q')  !== null, 'Q not HiZ');
  assert(getPin(comp,'ER') !== null, 'ER not HiZ');
});
...
test('74402 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x402'], 'chip missing');
});
test('74402 outputs are driven (stub drives 0)', () => {
  const comp = makeComp('74x402');
...
test('74403 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x403'], 'chip missing');
});
test('74403 OEn=1 → data outputs HiZ', () => {
  const comp = makeComp('74x403');
...
test('74405 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x405'], 'chip missing');
});
test('74405 enabled: only selected output LOW', () => {
  const comp = makeComp('74x405');
...
test('74407 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x407'], 'chip missing');
});
test('74407 CLRn=0 → all Q=0', () => {
  const comp = makeComp('74x407');
...
test('74410 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x410'], 'chip missing');
});
test('74410 write and read back', () => {
  const comp = makeComp('74x410');
...
test('74412 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x412'], 'chip missing');
});
test('74412 MD=0 (input mode): STB rising captures DI', () => {
  const comp = makeComp('74x412');
...
test('74413 exists in CHIPS_BLOCK_24', () => {
  assert(CHIPS_BLOCK_24['74x413'], 'chip missing');
});
test('74413 empty FIFO → EF=1', () => {
  const comp = makeComp('74x413');
