...
export const CHIPS_BLOCK_15 = {
  ...
  '74206': {
    ...
    description: '256 bit static RAM organized as 256 words × 1 bit with open-collector output (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
    openCollector: true,
  ...
  '74207': {
    ...
    description: '1024 bit static RAM organized as 256 words x 4 bits; common I/O; 3-state outputs (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
  ...
  '74208': {
    ...
    description: '1024 bit static RAM organized as 256 words x 4 bits; separate data inputs and outputs; 3-state (20-pin)',
    pins: 20,
    vcc: 20,
    gnd: 10,
  ...
  '74209': {
    ...
    description: '1024 bit static RAM organized as 1024 words x 1 bit with 3-state output (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
  ...
  '74215': {
    ...
    description: '1024 bit static RAM organized as 1024 words x 1 bit with 3-state output and power-down mode (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
  ...
  '74216': {
    ...
    description: '256 bit static RAM organized as 64 words x 4 bits; common I/O; 3-state outputs (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
  ...
  '74217': {
    ...
    description: '256 bit static RAM organized as 64 words x 4 bits; separate data inputs/outputs; 3-state (20-pin)',
    pins: 20,
    vcc: 20,
    gnd: 10,
  ...
  '74218': {
    ...
    description: '256 bit static RAM organized as 32 words x 8 bits; common I/O; 3-state outputs (20-pin)',
    pins: 20,
    vcc: 20,
    gnd: 10,
  ...
  '74219': {
    ...
    description: '64 bit static RAM (16 words x 4 bits) with non-inverting 3-state data outputs (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
  ...
  '74222': {
    ...
    description: '64 bit synchronous FIFO memory (16 words x 4 bits) with input/output ready signals (20-pin)',
    pins: 20,
    vcc: 20,
    gnd: 10,
  ...
  '74224': {
    ...
    description: '64 bit synchronous FIFO memory (16 words x 4 bits) with empty/full flags (16-pin)',
    pins: 16,
    vcc: 16,
    gnd: 8,
